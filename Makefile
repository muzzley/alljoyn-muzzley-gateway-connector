...
else ifeq ($(CPU),openwrt)
    CC	:= mips-openwrt-linux-g++
    LD	:= mips-openwrt-linux-g++
else
    CC := g++
    LD := g++
endif
...
CFLAGS    := -Wall -pipe -std=c++98 -fno-rtti -fno-exceptions -Wno-long-long -Wno-deprecated -DDEBUG -g3 -g -DQCC_OS_LINUX -DQCC_OS_GROUP_POSIX -fexceptions
CXXFLAGS  := -Wall -pipe -std=c++98 -fno-rtti -fno-exceptions -Wno-long-long -Wno-deprecated -DDEBUG -g3 -g -DQCC_OS_LINUX -DQCC_OS_GROUP_POSIX -fexceptions
...
LIBS += -lalljoyn_gwconnector -lalljoyn_config -lalljoyn_notification -lalljoyn_about -lalljoyn_services_common -lalljoyn -lxml2 -lssl -lcrypto -lresolv -lstdc++ -lpthread -lrt -lz -lgcc_s -lc -luuid


#LIBSTROPHE
ifdef LIBSTROPHE_INCDIR
  INCLUDES += -I$(LIBSTROPHE_INCDIR)/include
ifdef LIBSTROPHE_LIBDIR
  LDFLAGS += -L$(LIBSTROPHE_LIBDIR)/lib
  LIBS += -lstrophe 
